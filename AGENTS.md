...
**v-vectors** (`v-vectors`) -- Scalable Vector Graphics for Vue 3.
...
v-vectors/
├── src/
│   ├── components/     # VSvg component
│   ├── utils/          # SVG config utilities
│   ├── index.ts        # Public exports
│   └── install.ts      # Vue plugin installer
├── types/
│   └── index.d.ts      # Marker, Circle, Path type definitions
